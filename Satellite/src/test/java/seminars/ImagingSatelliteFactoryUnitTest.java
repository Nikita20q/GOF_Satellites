...
public class ImagingSatelliteFactoryUnitTest {
    ...
    void testCreateImagingSatellite() {
        ImagingSatellite satellite = satelliteFactory.createSatelliteWithParameter(SATELLITE_NAME, BATTERY_LEVEL, RESOLUTION);
    ...
    void testCreateSatelliteWithMinBatteryLevel() {
        ImagingSatellite satellite = satelliteFactory.createSatelliteWithParameter(SATELLITE_NAME, 0, RESOLUTION);
